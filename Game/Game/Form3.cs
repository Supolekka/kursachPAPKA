...
namespace Game
{
    public partial class Form3 : Form
    {
        ...
        {
            // Два числа (сложение)
            addend1 = randomizer.Next(150, 300);
            addend2 = randomizer.Next(50, 250);
            ...
            // Два числа (вычитание)
            minuend = randomizer.Next(200, 300);
            subtrahend = randomizer.Next(150, minuend);
            minusLeftLabel.Text = minuend.ToString();
            minusRightLabel.Text = subtrahend.ToString();
            difference.Value = 0;

            // Два числа (умножение)
            multiplicand = randomizer.Next(15, 30);
            multiplier = randomizer.Next(10, 15);
            timesLeftLabel.Text = multiplicand.ToString();
            timesRightLabel.Text = multiplier.ToString();
            product.Value = 0;

            // Два числа (деление)
            divisor = randomizer.Next(10, 100);
            int temporaryQuotient = randomizer.Next(5, 22);
